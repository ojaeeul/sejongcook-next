...
if (!sheetHtml.includes('window.calculateLocalRedBoxesForMonth = function')) {
    sheetHtml = sheetHtml.replace(insertTarget, localFunc + '\n' + insertTarget);
    console.log('Successfully injected calculateLocalRedBoxesForMonth.');
} else {
...
sheetHtml = sheetHtml.replace(/v=202606111000/g, 'v=202606111020');
