...
export default function CommunitySidebar() {
    ...
    const menuItems = [
        ...
        { name: '관련사이트', path: '/community/sites' },
        { name: '명예의 전당', path: '/community/honor' },
    ];

    // Community: Trust Blue (#0984E3) - Matching Intro/Info sections for consistency
    const theme = {
    ...
    return (
        <div className="w-full">
            ...
            {/* Menu List - Collapsible on Mobile, Always Visible on Desktop */}
            ...
            <div className="hidden xl:block mt-8 bg-white p-6 rounded-lg text-center border border-gray-100 shadow-sm">
                ...
                <Link href="/inquiry" className="block w-full bg-[#1F2937] text-white py-3 rounded font-bold hover:bg-slate-700 transition-colors shadow-sm" style={{ color: '#fff' }}>
                    온라인 상담신청
                </Link>
            </div>
        </div>
