...
export default function Header({ initialShowAuthLinks = true }: { initialShowAuthLinks?: boolean }) {
    ...
    useEffect(() => {
        ...
        fetch('/data/settings.json?_t=' + Date.now(), { cache: 'no-store' })
            .then(res => {
    ...
    const navigation = [
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: '질문오토봇', href: '/community/qna' },
                ...
                <div className="max-w-[1200px] mx-auto px-4 h-[80px] flex justify-between items-center">
                    ...
                    <div className="!hidden lg:!flex items-center gap-3 text-sm text-gray-600">
                        ...
                        <div className="flex gap-2 mr-2">
                            ...
                            >
                                {/* Message Circle Icon */}
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="#FEE500" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-600 group-hover:text-[#3A1D1D]">
                                    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                                </svg>
                                <span className="text-xs font-medium text-gray-700">카카오톡상담</span>
