...
# ==============================================================================
# [STEP 0-PRE] 깃허브(Git)에서 최신 파일 다운로드 (다른 컴퓨터/웹 작업분 동기화)
# ==============================================================================
echo "[0/6] 웹(GitHub)에서 최신 데이터를 다운로드하여 로컬에 적용합니다..."
# 기존 로컬 변경사항이 날아가지 않도록 우선 저장
git add .
git diff-index --quiet HEAD || git commit -m "Auto save before pull: $(date)"
# 최신 내역 덮어쓰기 (가져오기)
git pull origin main --no-rebase -X theirs
echo "    ✅ 웹 파일 다운로드 및 로컬 덮어쓰기 완료"
echo ""
