...
# ==============================================================================
# [STEP 1] Supabase 데이터 가져오기 및 JSON 데이터 동기화
# ==============================================================================
echo "[1/4] Supabase 클라우드에서 최신 데이터를 다운로드하여 동기화 중..."
node sync_from_supabase.mjs
...
echo "    ✅ 클라우드 데이터 다운로드 및 JSON 동기화 완료"
echo ""
...
# ==============================================================================
# [STEP 5] Supabase 데이터 동기화 (기존 덮어쓰기 로직 제거됨)
# ==============================================================================
echo ""
echo "[5/6] Supabase 데이터 동기화 완료 (시작 시 자동 다운로드 완료됨)"
echo ""

# ==============================================================================
# [STEP 6] Vercel 실서버 자동 배포 (Background)
# ==============================================================================
echo ""
echo "[6/6] Vercel 실서버 자동 업로드(배포)를 백그라운드에서 진행합니다..."
