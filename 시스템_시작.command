...
# ==============================================================================
# [STEP 0-PRE] 깃허브(Git)에서 최신 파일 강제 다운로드 (무조건 100% 덮어쓰기)
# ==============================================================================
echo "[0/6] 웹(GitHub)에서 최신 원본 데이터를 100% 다운로드 및 덮어쓰기 합니다..."
# git fetch -v --all
# git reset --hard origin/main
# git clean -fd
echo "------------------------------------------------------"
echo "    ✅ 웹 원본 파일 다운로드 및 100% 덮어쓰기가 완료되었습니다!"
echo "------------------------------------------------------"
echo "(3초 후 자동으로 다음 시스템 부팅 단계로 넘어갑니다...)"
sleep 3
echo ""
...
# ==============================================================================
# [STEP 5] Vercel 실서버 자동 배포 및 옛날 기록 정리 (Background)
# ==============================================================================
echo ""
echo "[5/6] Vercel 실서버 자동 업로드(배포)를 백그라운드에서 진행합니다..."
...
nohup npx vercel rm sejongcook-next-uoxe --safe --yes > vercel_cleanup.log 2>&1 &
echo "    ✅ 과거 기록 정리 명령 전달 (백그라운드에서 조용히 진행됩니다)"
echo ""
