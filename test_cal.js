...
const smsV3Code = fs.readFileSync('../sejongcook_final_deploy/sejong/sms_v3.js', 'utf8');
const sharedCalcCode = fs.readFileSync('../sejongcook_final_deploy/sejong/shared_calc.js', 'utf8');
