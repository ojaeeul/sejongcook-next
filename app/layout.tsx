...
export const metadata: Metadata = {
  ...
  keywords: [
    "요리학원", "김포요리학원", "쿠킹클래스", "원데이클래스", "원데", 
    "세종요리학원", "세종요리기술학원", "세종요리제과학원", "김포제과제빵요리학원",
    "김포제과학원", "김포제빵학원", "김포바리스타학원", 
    "인천요리학원", "검단요리학원", "일산요리학원", "계양요리학원", 
    "취미요리", "가정요리", "과정요리", "김포쿠킹클래스", "요리동아리",
    "사우요리학원", "북변요리학원", "장기요리학원", "구래요리학원", "고촌요리학원", 
    "풍무요리학원", "운양요리학원", "김포본동요리학원", "마산요리학원", 
    "국비지원요리학원", "내일배움카드요리학원", "내일배움카드", 
    "기능사", "조리기능사", "제과기능사", "재빵기능사", "제과제빵기능사", "제빵제과기능사",
    "바리스타자격증", "자격증", "취업", "창업"
  ],
  icons: {
    icon: '/favicon.ico',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "세종요리제과기술학원",
              "alternateName": [
                "요리학원", "쿠킹클래스", "원데이클래스", "원데",
                "김포요리학원", "세종요리학원", "세종요리제과학원", "세종요리기술학원", 
                "김포제과학원", "김포제빵학원", "김포쿠킹클래스", "사우요리학원", 
                "장기요리학원", "구래요리학원", "검단요리학원", "인천요리학원",
                "일산요리학원", "국비지원요리학원", "내일배움카드요리학원",
                "기능사", "조리기능사", "제과기능사", "재빵기능사", "제빵제과기능사",
                "취미요리", "과정요리", "가정요리"
              ],
