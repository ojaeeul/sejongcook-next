    ...
    return (
        <div className="flex justify-end mt-2">
            <button
                ...
                className="bg-[#999] text-white text-[11px] px-2 py-1 rounded-sm hover:bg-[#777] transition-colors"
    ...
    return (
        <div className="max-w-[1200px] mx-auto py-12 px-4 flex flex-col md:flex-row gap-10 font-sans">
                ...
                <div className="bg-white border-t-2 border-[#333]">
                    ...
                    <ul className="text-sm text-gray-600">
                        <li className="border-b border-[#eee]">
                            <Link href="/terms" className="block py-3 px-2 bg-gray-50 text-orange-500 font-bold flex justify-between items-center group transition-colors">
                                <span>이용약관</span>
            ...
            <div className="flex-1">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-[#333] border-b-2 border-[#333] pb-4">이용약관</h1>
                </div>
                <div className="text-[#555] text-sm leading-7 space-y-8">
                    <div className="bg-gray-50 p-6 rounded border border-gray-200 text-center">
                        <p className="mb-2">※ 김포세종요리제과기술학원은<br />공정거래위원회에서 심의한 표준약관을 사용하고 있음.</p>
                        <h5 className="text-sm font-semibold text-gray-500">공정거래위원회 표준약관 제10023호</h5>
                        <h3 className="text-xl font-bold text-[#333] mt-2">인터넷 사이버몰 利用標準約款</h3>
                    </div>
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제1조(목적)</h4>
                        <p>이 약관은 세종요리제과기술학원 회사(전자상거래 사업자)가 운영하는 세종요리제과기술학원 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.<br />※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
                        <TopBtn />
                    </div>
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제2조(정의)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                            <li>“몰” 이란 세종요리제과기술학원 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
                            <li>“이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.</li>
                            <li>&lsquo;회원&rsquo;이라 함은 “몰”에 개인정보를 제공하여 회원등록을 한 자로서, “몰”의 정보를 지속적으로 제공받으며, “몰”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.</li>
                            <li>&lsquo;비회원&rsquo;이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.</li>
                        </ol>
                        <TopBtn />
                    </div>
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제3조 (약관등의 명시와 설명 및 개정)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                            ...
                            <li>“몰”이 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간내에 &lsquo;몰“에 송신하여 ”몰“의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.</li>
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제4조(서비스의 제공 및 변경)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제5조(서비스의 중단)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제6조(회원가입)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제7조(회원 탈퇴 및 자격 상실 등)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제8조(회원에 대한 통지)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제9조(구매신청)</h4>
                        <div>
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제10조 (계약의 성립)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제11조(지급방법)</h4>
                        <div>
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제12조(수신확인통지.구매신청 변경 및 취소)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제13조(재화등의 공급)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제14조(환급)</h4>
                        <div>
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제15조(청약철회 등)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제16조(청약철회 등의 효과)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제17조(개인정보보호)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제18조(“몰“의 의무)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제19조(회원의 ID 및 비밀번호에 대한 의무)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제20조(이용자의 의무)</h4>
                        <div>
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제21조(연결“몰”과 피연결“몰” 간의 관계)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제22조(저작권의 귀속 및 이용제한)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제23조(분쟁해결)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
                    ...
                    <div>
                        <h4 className="font-bold text-[#333] mb-2">제24조(재판권 및 준거법)</h4>
                        <ol className="list-decimal pl-5 space-y-1">
